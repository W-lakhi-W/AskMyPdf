...
function AppLayout({ children }) {
  ...
  const refreshSessions = useCallback(async () => {
    try {
      const response = await listChatSessions(effectiveUserId);
      setSessions(response ?? []);
      setActiveSessionId(getStoredChatSessionId(effectiveUserId));
    } catch {
      setSessions([]);
    }
  }, [effectiveUserId]);
  ...
  const handleNewChat = () => {
    removeStoredChatSessionId(effectiveUserId);
    setActiveSessionId(null);
    notifyChatSessionChanged(null);
    navigate("/");
  };
  const handleSelectSession = (sessionId) => {
    setStoredChatSessionId(effectiveUserId, sessionId);
    setActiveSessionId(sessionId);
    notifyChatSessionChanged(sessionId);
    navigate("/");
  };
  const handleDeleteSession = async (session) => {
    await deleteChatSession(session.session_id, effectiveUserId);
    setSessions((current) =>
    ...
    children: [
      /* @__PURE__ */ jsxs("aside", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("nav", {
            style: { display: "grid", gap: designTokens.spacing.sm },
          ...
          /* @__PURE__ */ jsx("button", {
            ...
            children: /* @__PURE__ */ jsxs("span", {
              ...
              children: [/* @__PURE__ */ jsx(LogOut, { size: 16 }), "Logout"],
            }),
          }),
          /* @__PURE__ */ jsxs("div", {
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", {
                    ...
                    children: `Signed in as ${userId ?? DEFAULT_USER_ID}`,
                  }),
                  /* @__PURE__ */ jsx("div", {
                    style: {
                      color: designTokens.colors.textMuted,
      ...
      /* @__PURE__ */ jsx(Modal, {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          style: { display: "grid", gap: designTokens.spacing.lg },
          children: [
            /* @__PURE__ */ jsxs("p", {
              style: { margin: 0, color: designTokens.colors.textMuted },
              children: [
